...
<head>
    ...
    <style>
        ...
        .header { background: #AF7A6D; padding: 30px; text-align: center; }
        .header h1 { color: #fff; margin: 0; font-size: 24px; }
        .body { padding: 30px; color: #333; }
        .mission-box { background: #f9f0ee; border-left: 4px solid #AF7A6D;
...
<div class="container">
    <div class="header">
        <h1>Désistement Enregistré</h1>
    </div>
    <div class="body">
        <h2>Bonjour {{ $user->name }},</h2>
        <p>Votre désistement de la mission suivante a bien été pris en compte :</p>
        ...
        <p>D'autres missions sont disponibles sur la plateforme. N'hésitez pas à vous inscrire !</p>
    </div>
    <div class="footer">
