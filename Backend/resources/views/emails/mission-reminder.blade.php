...
<div class="container">
    <div class="header">
        <h1>Rappel Mission</h1>
    </div>
    <div class="body">
        <h2>Bonjour {{ $user->name }},</h2>
        <p>Nous vous rappelons que vous êtes inscrit à la mission suivante <strong>dans 2 jours</strong> :</p>
        ...
        <p>Soyez ponctuel et prêt pour cette belle aventure bénévole !</p>
        <p>À très bientôt</p>
    </div>
    <div class="footer">
